...
use CoolPay\API\Constants;
use CoolPay\API\Response;

/**
 * @class      CoolPay_Request
 * @since      0.1.0
 * @package    CoolPay
 * @category   Class
 * @author     Patrick Tolvstein, Perfect Solution ApS
 * @docs       http://www.coolpay.com/docs
 */
class Request
{
    /**
     * Contains CoolPay_Client instance
     *
     * @access protected
     */
    protected $client;
    ...
    /**
     * Improves http_build_query() for the CoolPay use case.
     *
